...
// no need to change them hear.

/**
 * Number of Samples
 * 
 * number of samples that we are going to record. 
 * 2^22, four million samples, should give you decent result.
 ...
 *
 * We have too buffers, one for DAC, and one for ADC.
 ...
 * (The best reasoning you ever have ever heard!).
 * NUMBER_OF_BUFFERS, must 4, 8, 16, 32 and probably 64. It must be power of two.
...
void setup() {
   ...
   * which is 2Mhz of 16 bit random numbers, more than enough for our purpose.
  */
  trng_enable(TRNG);  
...
void loop() {
  ...
  * TIOA1 controls DAC.
  * TIOA0 controls ADC.
  * ADC is half sample late, Because we want to measure the center of the signal,
  * generated by DAC.
  */
 ...
 * Timings
 *
 * To see the following figure, you should use mono space font.
 *
